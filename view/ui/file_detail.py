...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.groupBox_fileInfo = QGroupBox(Form)
        ...
        self.groupBox_fileScanResult = QGroupBox(Form)
    ...
    def retranslateUi(self, Form):
        ...
        self.groupBox_fileInfo.setTitle(QCoreApplication.translate("Form", u"File Details", None))
        ...
        self.groupBox_fileScanResult.setTitle(QCoreApplication.translate("Form", u"Analysis Results", None))
        self.label_5.setText(QCoreApplication.translate("Form", u"Status:", None))
        self.label_fileScanStatus.setText("")
        self.label_4.setText(QCoreApplication.translate("Form", u"Detection:", None))
        self.label_fileScanDetection.setText("")
        ___qtreewidgetitem1 = self.tbl_fileScanResult.headerItem()
        ___qtreewidgetitem1.setText(1, QCoreApplication.translate("Form", u"Result", None));
        ___qtreewidgetitem1.setText(0, QCoreApplication.translate("Form", u"Engine", None));
        self.label.setText(QCoreApplication.translate("Form", u"Elapsed time:", None))
